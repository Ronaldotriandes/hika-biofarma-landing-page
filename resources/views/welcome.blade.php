  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        ...
        <li style="padding-right:20px"><img src="/images/ilyas Foto 1.png" alt="User" class="rounded-circle" style="width: 60px; height: 60px; object-fit: cover; margin-right: 5px;"></li>
        <li><a href="#">Ilyas Rasyid Alfattah</a></li>
        <li><a href="#" style="color:#55A9B6">Member</a></li>
        <li><a href="#">Home</a></li>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div id="hero-carousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-container">
            <div class="text-center mb-4" style="width: 70%;">
            <img src="images/serikatjuang.jpg" alt="Slide Image" class="img-fluid animate__animated animate__fadeIn banner-image" >
            </div>
            <h2 class="animate__animated animate__fadeInDown">New Slide With Image</h2>
            <p class="animate__animated animate__fadeInUp">Add your slide description here. This slide includes an image above the text.</p>
            <a href="#about" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
        </div>
        </div>
